                        ...
                        <form action="{{ route('author.update', $author->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" disabled class="form-control @error('email') is-invalid @enderror"
                                    name="email" id="email" value="{{ $author->email }}" placeholder="Email">
                                @error('email')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                                    id="name" value="{{ $author->name }}" placeholder="Name">
                                @error('name')
                                    <small class="invalid-feedback font-weight-bold" role="alert">
                                        {{ $message }}
                                    </small>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('author') is-invalid @enderror" name="author"
                                    id="author" value="{{ $author->author }}" placeholder="Author Name">
                                @error('author')
                                    <small class="invalid-feedback font-weight-bold" role="alert">
                                        {{ $message }}
                                    </small>
                            ...
                            <div class="form-group ">
                                ...
                                <input type="file" id="photo" onchange="previewFile(this);" name="photo"
                                    class="form-control d-none p-1 mr-2 overflow-hidden @error('photo') is-invalid @enderror">
                                @error('photo')
                                    <small class="invalid-feedback font-weight-bold" role="alert">
                                        {{ $message }}
                                    </small>
                                @enderror
                                <a id="edit" onclick="$('#photo').trigger('click');" class="btn text-white btn-primary btn-sm"
                                    style="position:absolute; right: 22px;">
                                    <i class="fas fa-edit "></i>
                                </a>
                                <img id="previewImg" onclick="$('#photo').trigger('click');" class="w-100 rounded"
                                    src="{{ asset('storage/author/photo/' . $author->photo) }}" alt="your image" />
                            </div>
                            <div class="form-group">
                                <label for="card">Id Card</label>
                                <input type="text" class="form-control @error('card') is-invalid @enderror" name="card"
                                    id="card" value="{{ $author->card }}" placeholder="Id Card">
                                @error('card')
                                    <small class="invalid-feedback font-weight-bold" role="alert">
                                        {{ $message }}
                                    </small>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone"
                                    id="phone" value="{{ $author->phone }}" placeholder="Phone">
                                @error('phone')
                                    <small class="invalid-feedback font-weight-bold" role="alert">
                                        {{ $message }}
                                    </small>
